...
function writeContent(Calendrier $cal) {
	...
	<form action="admin-commandes.html" method="get">
		...
		<input id="date_order" name="date_order" type="text" value="<?php echo CalendrierImp::frenchDate($cal->nextValidDay()); ?>"></label><br />
	...
	<form action="admin-produits-commandes.html" method="get">
		...
		<input id="date_products" name="date_products" type="text" value="<?php echo CalendrierImp::frenchDate($cal->nextValidDay()); ?>"></label><br />
		<input type="submit" value="Valider" />
	</form>
